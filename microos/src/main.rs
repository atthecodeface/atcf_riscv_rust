...
pub const APB_UART:             *mut u32 = apb_dev!(4,0) as *mut u32;
pub const APB_RV_SRAM:          *mut u32 = apb_dev!(7,0) as *mut u32;
pub const APB_FB_SRAM:          *mut u32 = apb_dev!(9,0) as *mut u32;
